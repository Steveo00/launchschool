...
# Keep the first 2 digits fixed in place and rotate again to 321759. Keep the first 3 
# digits fixed in place and rotate again to get 321597. Finally, keep the first 4 digits 
# fixed in place and rotate the final 2 digits to get 321579. The resulting number is 
...
# You can (and probably should) use the rotate_rightmost_digits method from the previous 
# exercise.
...
def max_rotation(number)
  max_digits = number.to_s.size
  max_digits.downto(2) do |n|
